...
////--------------------------////
    ...
    //const char ssid[] = "NewEarthWireless_optout";
    //const char pass[] = "r2nomusennran";

    //const char ssid[] = "Home Network";
    //const char pass[] = "17242QkHNj";

    #define HOSTNAME "/IoT/oled/Suzukake/01"
    //#define HOSTNAME "/IoT/T&H/Suzukake/02"
    
    //const char MQTT_HOST[] = "tangle.anushkawijesundara.com";
    const char MQTT_HOST[] = "192.168.4.1";
    const int  MQTT_PORT = 8883;
    const char MQTT_USER[] = "iot"; // leave blank if no credentials used
    const char MQTT_PASS[] = "iot"; // leave blank if no credentials used
    
    const char IOT_FW_VER[]  = "12349"; //Every new version should add here and 
    const int FW_VERSION = 12349; // here...
    
    const char* fwUrlBase = "http://192.168.4.1/firmwares/";
...
/////////////// Let's Encrypt Public Certiciate /////////////////
/////////////// tangle.anushkawijesundara.com   /////////////////
...
/*
  ...
  if (strcmp(topic,"IoT/Firmware_Udate/out")==0){
    Serial.println("");
    Serial.print("Firmware Update Information Recieved");
    Serial.println("");
    //checkForUpdates();
  }
  */
